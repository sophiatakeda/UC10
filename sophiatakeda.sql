...
datajogo TIMESTAMP,
estadio_idesdtadio INTEGER,
pais_ispais_1 INTEGER,
pais_ispais_2 INTEGER,
gols_ispais_1 INTEGER,
gols_ispais_2 INTEGER,
publico INTEGER
);

ALTER TABLE jogos ADD constraint fk_idpais_1 foreign key (pais_idpais_1) REFERENCES pais(IDpais);
ALTER TABLE jogos ADD constraint fk_idpais_2 foreign key (pais_idpais_2) REFERENCES pais(IDpais);
ALTER TABLE jogos ADD constraint fk_idestadio foreign key (estadio_idestadio) REFERENCES estadio(IDestadio);
...
ALTER TABLE jogador ADD constraint fk_idpais_3 foreign key (pais_idpais_3) REFERENCES pais(IDpais);
...
ALTER TABLE cartao ADD constraint fk_idrodada foreign key (jogos_idrodada) REFERENCES jogos(IDrodada);
ALTER TABLE cartao ADD constraint fk_idjogador foreign key (jogador_idjogador) REFERENCES jogador(IDrodada);

CREATE TABLE grupo (
idgrupo VARCHAR(25) PRIMARY KEY,
descricao VARCHAR(25)
);
...
ALTER TABLE gols ADD constraint fk_idrodada_1 foreign key (jogos_idrodada) REFERENCES jogos(IDrodada);
ALTER TABLE gols ADD constraint fk_idjogador_1 foreign key (jogador_idjogador) REFERENCES jogador(IDrodada);
